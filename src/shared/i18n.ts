const FALLBACK_MESSAGES = {
  ...
  notification_pin_chat: 'Pin Chat',
  notification_unpin_chat: 'Unpin Chat',
  notification_branch_chat_not_found: 'No assistant message found',
  notification_copy_last_user_message_missing: 'No user message found to copy',
  notification_copy_last_user_message_success: 'Last user message copied',
